...
app.layout = html.Div([
    ...
    'font-weight': 'bold', 'text-align-last':'center',
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        unemployment_effect = data.groupby(['Vehicle_Type'])['unemployment_rate'].mean().reset_index()
        R_chart4 = dcc.Graph(
    ...
    # Yearly Statistic Report Plots                             
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title='Yearly Automobile Sales for the Year {}'.format(input_year)))
